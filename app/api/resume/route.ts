  ...
  try {
    ...
    const response = await client.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: `You are a professional resume tailoring assistant for Jyothi Swaroop S. Your job is to analyze a job description and match it against Swaroop's complete profile to produce a tailored resume summary.
