  ...
  try {
    ...
    const response = await client.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: `You are a project recommendation engine for Jyothi Swaroop S's portfolio. Given a visitor's intent, recommend the top 3 most relevant projects from the knowledge base below.
