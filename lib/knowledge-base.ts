...
- Bank Statement Analyzer (2026) — AI FinTech tool converting statements to voucher files. GPT-4o-mini, 8 export modes, RAG chatbot
- NLP Ticket Classifier (2025) — Zero-shot classification with BART-large-mnli + SLA tracking
- Trails & Miles (2025) — AI travel planner with GPT-4o itinerary generation, RAG chatbot, 6 countries, 36+ cities
- StationeryHub (2025) — B2B/B2C e-commerce with AI search + Razorpay
- Enterprise Forecasting (2025) — ARIMA + XGBoost + Gemini AI forecasting platform
- AI Email Automation (2025) — Intelligent email processing and workflow automation
- Customer Churn Dashboard (2025) — Random Forest + XGBoost prediction dashboard
