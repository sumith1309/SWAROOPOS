...
const DOCK_GROUPS: DockApp[][] = [
  ...
  [
    ...
    { id: "resumetailor", label: "AI Resume Tailor", color: "#10B981", icon: <><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><polyline points="14 2 14 8 20 8" /><line x1="16" y1="13" x2="8" y2="13" /><line x1="16" y1="17" x2="8" y2="17" /></> },
    { id: "recommender", label: "AI Project Guide", color: "#8B5CF6", icon: <><circle cx="12" cy="12" r="10" /><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3" /><line x1="12" y1="17" x2="12.01" y2="17" /></> },
    { id: "aidemo", label: "AI Playground", color: "#F97316", icon: <><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2" /></> },
  ],
  // Domains
  [
